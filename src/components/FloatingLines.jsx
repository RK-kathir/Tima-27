...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  vec3 col = vec3(0.0);
  float alpha = 0.0; // Tracks transparency for Light Theme support
  ...
  // Pre-multiplied alpha for perfect transparent blending on white backgrounds
...
export default function FloatingLines({
  ...
  mixBlendMode = 'normal' // Changed to normal so dark colors appear on light themes
}) {
  ...
  useEffect(() => {
    ...
    if (interactive) {
      ...
      renderer.domElement.addEventListener('pointerleave', () => targetInfluenceRef.current = 0.0);
    }
